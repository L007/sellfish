    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home_pembeli:

                    replaceFragment(Fragment_home_pembeli.newInstance());

                    return true;
                case R.id.navigation_katalog_pembeli:
                    replaceFragment(Fragment_katalog_pembeli.newInstance());
                    return true;
                case R.id.navigation_transaksi_pembeli:
                    replaceFragment(Fragment_transaksi_penjual.newInstance());
                    return true;
                case R.id.navigation_profil_pembeli:
